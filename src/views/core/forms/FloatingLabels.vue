        ...
        <CCardBody>
          ...
          <DocsExample href="forms/floating-labels.html">
            ...
            <CFormFloating>
              ...
              />
              <CFormLabel for="floatingPassword">
                Password
              </CFormLabel>
            </CFormFloating>
          </DocsExample>
          ...
          <DocsExample href="forms/floating-labels.html">
            <CFormFloating>
              ...
              />
              <CFormLabel for="floatingInputValue">
                Input with value
              </CFormLabel>
            </CFormFloating>
          </DocsExample>
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/floating-labels.html#textareas">
            <CFormFloating>
              ...
              />
              <CFormLabel for="floatingTextarea">
                Comments
              </CFormLabel>
            </CFormFloating>
          </DocsExample>
          ...
          <DocsExample href="forms/floating-labels.html#textareas">
            <CFormFloating>
              <CFormTextarea
                ...
                style="height: 100px"
              />
              <CFormLabel for="floatingTextarea2">
                Comments
              </CFormLabel>
            </CFormFloating>
          </DocsExample>
            ...
            <CRow :xs="{ gutter: 2 }">
              <CCol md>
                <CFormFloating>
                  ...
                  />
                  <CFormLabel for="floatingInputGrid">
                    Email address
                  </CFormLabel>
                </CFormFloating>
              </CCol>
