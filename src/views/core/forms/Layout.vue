        ...
        <CCardBody>
          ...
          <DocsExample href="forms/layout.html#gutters">
            <CForm class="row g-3">
              ...
              <CCol :md="6">
                <CFormLabel for="inputCity">
                  City
                </CFormLabel>
                <CFormInput id="inputCity" />
              </CCol>
              <CCol :md="4">
                <CFormLabel for="inputState">
                  State
                </CFormLabel>
