      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/validation.html#browser-defaults">
            ...
            >
              <CCol :md="4">
                <CFormLabel for="validationDefault01">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol :md="4">
                <CFormLabel for="validationDefault02">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol :md="6">
                <CFormLabel for="validationDefault03">
                  City
                </CFormLabel>
                <CFormInput
              ...
              <CCol :md="3">
                <CFormLabel for="validationDefault04">
                  City
                </CFormLabel>
              ...
              <CCol :md="3">
                <CFormLabel for="validationDefault05">
                  City
                </CFormLabel>
                <CFormInput
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/validation.html#server-side">
            <CForm class="row g-3 needs-validation">
              <CCol ::md="4">
                <CFormLabel for="validationServer01">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol ::md="4">
                <CFormLabel for="validationServer02">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol ::md="4">
                <CFormLabel for="validationServerUsername">
                  Username
                </CFormLabel>
                <CInputGroup class="has-validation">
              ...
              <CCol :md="6">
                <CFormLabel for="validationServer03">
                  City
                </CFormLabel>
                <CFormInput
              ...
              <CCol :md="3">
                <CFormLabel for="validationServer04">
                  City
                </CFormLabel>
                <CFormSelect
              ...
              <CCol :md="3">
                <CFormLabel for="validationServer05">
                  City
                </CFormLabel>
                <CFormInput
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/validation.html#tooltips">
            ...
            >
              ...
              >
                <CFormLabel for="validationTooltip01">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol
                ...
                class="position-relative"
              >
                <CFormLabel for="validationTooltip02">
                  Email
                </CFormLabel>
                <CFormInput
              ...
              <CCol
                ...
                class="position-relative"
              >
                <CFormLabel for="validationTooltip03">
                  City
                </CFormLabel>
                <CFormInput
              ...
              <CCol
                ...
                class="position-relative"
              >
                <CFormLabel for="validationTooltip04">
                  City
                </CFormLabel>
                <CFormSelect
              ...
              <CCol
                ...
                class="position-relative"
              >
                <CFormLabel for="validationTooltip05">
                  City
                </CFormLabel>
                <CFormInput
